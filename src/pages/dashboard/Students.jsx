...
const getStudentCourseIdsForIdCard = (student, preferredCourseId = "all") => {
  const activeEnrollments = getActiveEnrollments(student);
  ...
  return uniqueCourseIds.length ? uniqueCourseIds.join(", ") : "N/A";
};
...
const Students = () => {
  ...
  const renderStudentIdFront = (student, preferredCourseId = "all") => {
    ...
    const courseIds = getStudentCourseIdsForIdCard(student, preferredCourseId);
